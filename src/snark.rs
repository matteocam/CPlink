...
use algebra_core::{
    ...
    AffineCurve, One, PairingEngine, ProjectiveCurve, ToBytes, UniformRand,
};
use rand::Rng;
use std::ops::Neg;

#[derive(Clone, Default, PartialEq)]
pub struct PP<G1: Clone + ToBytes + Default, G2: Clone + ToBytes + Default> {
    pub l: usize, // # of rows
    pub t: usize, // # of cols
    pub g1: G1,
    pub g2: G2,
...
impl<G1: Clone + ToBytes + Default, G2: Clone + ToBytes + Default> PP<G1, G2> {
...
impl<G1: Clone + ToBytes + Default, G2: Clone + ToBytes + Default> ToBytes for PP<G1, G2> {
...
#[derive(Clone, Default, PartialEq)]
pub struct EK<G1: Clone + ToBytes + Default> {
    pub p: Vec<G1>,
}

impl<G1: Clone + ToBytes + Default> ToBytes for EK<G1> {
    fn write<W: Write>(&self, _: W) -> IoResult<()> {
        unimplemented!();
    }
}
...
#[derive(Clone, Default, PartialEq)]
pub struct VK<G2: Clone + ToBytes + Default> {
    pub c: Vec<G2>,
    pub a: G2,
}

impl<G2: Clone + ToBytes + Default> ToBytes for VK<G2> {
    fn write<W: Write>(&self, _: W) -> IoResult<()> {
        unimplemented!();
    }
}
